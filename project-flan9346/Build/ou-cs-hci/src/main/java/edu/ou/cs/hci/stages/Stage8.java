...
public final class Stage8
{
	...
	public static void main(String[] args)
	{
		...
		//adds an add listener to the add button
		AddListener addLis = new AddListener(ufridge,urecipes,ugroceries, tabs);
		add.addActionListener(addLis);
